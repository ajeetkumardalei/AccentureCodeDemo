...
struct R: Rswift.Validatable {
  ...
  struct reuseIdentifier {
    ...
    static let dashboardCell: Rswift.ReuseIdentifier<DashboardCell> = Rswift.ReuseIdentifier(identifier: "DashboardCell")
...
struct _R: Rswift.Validatable {
  ...
  struct nib: Rswift.Validatable {
    ...
    struct _DashboardCell: Rswift.NibResourceType, Rswift.ReuseIdentifierType, Rswift.Validatable {
      typealias ReusableType = DashboardCell
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "person.crop.circle.fill.badge.minus", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'person.crop.circle.fill.badge.minus' is used in nib 'DashboardCell', but couldn't be loaded.") }
